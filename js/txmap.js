...
$.ajax({
    ...
    data: {
        key: 'SWSBZ-Z4CCQ-64X5S-47GQX-UG42O-NHFGV',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.734599, 33.898938, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    try {
        ...
        document.getElementById("welcome-info").innerHTML =
            `<center> <span class="welcome-hyy">🎉 欢迎信息 🎉</span> <center> <span class="welcome-hy">热烈欢迎来自~</span><br><span><span style="color: var(--icat-card-welcome);font-weight: bold;">${pos}</span> 的朋友</span><br><span class="welcome-message">${posdesc}</span><br>您当前位置距站长约 <b><span style="color: var(--icat-card-welcome);font-weight: bold;">${dist}</span></b> 公里！<br>您的IP地址为：<span class="welcome-ip">${ip}</span><br>${timeChange}`;
    } catch (err) {
